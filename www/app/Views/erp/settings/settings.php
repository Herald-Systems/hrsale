...
<div id="smartwizard-2" class="border-bottom smartwizard-example sw-main sw-theme-default mt-2">
    <ul class="nav nav-tabs step-anchor">
        <?php if (in_array('settings1', staff_role_resource()) || $user['user_type'] == 'company') { ?>
            <li class="nav-item active"><a href="<?= site_url('erp/system-settings'); ?>" class="mb-3 nav-link"> <span
                            class="sw-done-icon feather icon-check-circle"></span> <span
                            class="sw-icon feather icon-settings"></span>
        ...
        <?php if (in_array('settings2', staff_role_resource()) || $user['user_type'] == 'company') { ?>
            <li class="nav-item clickable"><a href="<?= site_url('erp/system-constants'); ?>" class="mb-3 nav-link">
                    <span class="sw-done-icon feather icon-check-circle"></span> <span
                            class="sw-icon feather icon-activity"></span>
        ...
        <?php if (in_array('settings3', staff_role_resource()) || $user['user_type'] == 'company') { ?>
            <li class="nav-item clickable"><a href="<?= site_url('erp/email-templates'); ?>" class="mb-3 nav-link">
                    <span class="sw-done-icon feather icon-check-circle"></span> <span
                            class="sw-icon feather icon-mail"></span>
        ...
        <?php if (in_array('settings4', staff_role_resource()) || $user['user_type'] == 'company') { ?>
            <li class="nav-item clickable"><a href="<?= site_url('erp/all-languages'); ?>" class="mb-3 nav-link"> <span
                            class="sw-done-icon feather icon-check-circle"></span> <span
                            class="sw-icon feather icon-flag"></span>
...
<div class="row">
        ...
        <div class="card user-card user-card-1">
            ...
            <div class="nav flex-column nav-pills list-group list-group-flush list-pills" id="user-set-tab"
                ...
                <a class="nav-link list-group-item list-group-item-action" id="payslips-tab"
                   data-toggle="pill" href="#payslips" role="tab" aria-controls="payslips"
                   aria-selected="true">
                ...
                <a
                        class="nav-link list-group-item list-group-item-action" id="account-system-logos-tab"
                        data-toggle="pill" href="#account-system-logos" role="tab" aria-controls="account-system-logos"
                        aria-selected="false"> <span class="f-w-500"><i class="feather icon-image m-r-10 h5 "></i>
                        <?= lang('Main.xin_system_logos'); ?>
                    </span>
                    <span class="float-right"><i class="feather icon-chevron-right"></i></span> </a> <a
                        class="nav-link list-group-item list-group-item-action" id="account-payment-tab"
                        data-toggle="pill" href="#account-payment" role="tab" aria-controls="account-payment"
                        aria-selected="false"> <span class="f-w-500"><i class="feather icon-credit-card m-r-10 h5 "></i>
      <?= lang('Main.xin_acc_payment_gateway'); ?>
      </span> <span class="float-right"><i class="feather icon-chevron-right"></i></span> </a> <a
                        class="nav-link list-group-item list-group-item-action" id="account-notification-tab"
                        data-toggle="pill" href="#account-notification" role="tab" aria-controls="account-notification"
                        aria-selected="false"> <span class="f-w-500"><i class="feather icon-crosshair m-r-10 h5 "></i>
      <?= lang('Main.xin_notification_position'); ?>
      </span> <span class="float-right"><i class="feather icon-chevron-right"></i></span> </a> <a
                        class="nav-link list-group-item list-group-item-action" id="user-set-email-tab"
                        data-toggle="pill" href="#user-set-email" role="tab" aria-controls="user-set-email"
                        aria-selected="false"> <span class="f-w-500"><i class="feather icon-mail m-r-10 h5 "></i>
    ...
    <div class="col-lg-9">
        <div class="tab-content" id="user-set-tabContent">
                    ...
                    <div class="card-body">
                        ...
                        <div class="bg-white">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                               placeholder="<?= lang('Main.xin_application_name'); ?>"
                                               name="application_name" type="text"
                                               value="<?= $xin_system['application_name']; ?>" id="application_name">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_ssl_available"
                                       name="is_ssl_available" <?php if ($xin_system['is_ssl_available'] == 1): ?> checked="checked" <?php endif; ?>
                                       value="1">
                                <label class="custom-control-label"
                                       for="is_ssl_available"><?= lang('Main.xin_installed_ssl_details_text'); ?></label>
                            </div>
                            <hr>
                            ...
                            <div class="row text-center">
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="2815767"
                                               value="2815767" <?php if ($xin_system['auth_background'] == '2815767'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="2815767"><a
                                                    href="<?= base_url(); ?>/assets/images/auth/2815767.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/2815767.jpg"
                                                        for="2815767" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="4859202"
                                               value="4859202" <?php if ($xin_system['auth_background'] == '4859202'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="4859202"><a
                                                    href="<?= base_url(); ?>/public/assets/images/auth/4859202.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/4859202.jpg"
                                                        for="4859202" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="4881040"
                                               value="4881040" <?php if ($xin_system['auth_background'] == '4881040'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="4881040"><a
                                                    href="<?= base_url(); ?>/public/assets/images/auth/4881040.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/4881040.jpg"
                                                        for="4881040" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="4899203"
                                               value="4899203" <?php if ($xin_system['auth_background'] == '4899203'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="4899203"><a
                                                    href="<?= base_url(); ?>/public/assets/images/auth/4899203.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/4899203.jpg"
                                                        for="4899203" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="4859203"
                                               value="4859203" <?php if ($xin_system['auth_background'] == '4859203'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="4859203"><a
                                                    href="<?= base_url(); ?>/public/assets/images/auth/4859203.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/4859203.jpg"
                                                        for="4859203" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="4904579"
                                               value="4904579" <?php if ($xin_system['auth_background'] == '4904579'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="4904579"><a
                                                    href="<?= base_url(); ?>/public/assets/images/auth/4904579.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/4904579.jpg"
                                                        for="4904579" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="4910284"
                                               value="4910284" <?php if ($xin_system['auth_background'] == '4910284'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="4910284"><a
                                                    href="<?= base_url(); ?>/public/assets/images/auth/4910284.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/4910284.jpg"
                                                        for="4910284" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="4888301"
                                               value="4888301" <?php if ($xin_system['auth_background'] == '4888301'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="4888301"><a
                                                    href="<?= base_url(); ?>/public/assets/images/auth/4888301.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/4888301.jpg"
                                                        for="4888301" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="4910910"
                                               value="4910910" <?php if ($xin_system['auth_background'] == '4910910'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="4910910"><a
                                                    href="<?= base_url(); ?>/public/assets/images/auth/4910910.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/4910910.jpg"
                                                        for="4910910" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="4914544"
                                               value="4914544" <?php if ($xin_system['auth_background'] == '4914544'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="4914544"><a
                                                    href="<?= base_url(); ?>/public/assets/images/auth/4914544.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/4914544.jpg"
                                                        for="4914544" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="4915973"
                                               value="4915973" <?php if ($xin_system['auth_background'] == '4915973'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="4915973"><a
                                                    href="<?= base_url(); ?>/public/assets/images/auth/4915973.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/4915973.jpg"
                                                        for="4915973" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="4931302"
                                               value="4931302" <?php if ($xin_system['auth_background'] == '4931302'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="4931302"><a
                                                    href="<?= base_url(); ?>/public/assets/images/auth/4931302.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/4931302.jpg"
                                                        for="4931302" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-4 col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="auth_background" class="form-check-input" id="2456057"
                                               value="2456057" <?php if ($xin_system['auth_background'] == '2456057'): ?> checked="checked" <?php endif; ?>>
                                        <label class="form-check-label" for="2456057"><a
                                                    href="<?= base_url(); ?>/public/assets/images/auth/2456057.jpg"
                                                    data-lightbox="roadtrip"><img
                                                        src="<?= base_url(); ?>/public/assets/images/auth/2456057.jpg"
                                                        for="2456057" class="img-fluid m-b-10 img-thumbnail bg-white"
                                                        alt=""></a></label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>
                            ...
                            <span class="p-l-5">Payslips</span>
                        </h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="tab-pane fade" id="account-system-logos" role="tabpanel"
                 aria-labelledby="account-system-logos-tab">
                <div class="card">
                    <div class="card-header">
                                ...
                                <div class="nav-tabs-top mb-4">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                                                href="#xin_system_logos">
                                                <?= lang('Main.xin_system_logos'); ?>
                                            </a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab"
                                                                href="#xin_payslip_invoice_logo_title">
                                                        ...
                                                        <div class="custom-file">
                                                            ...
                                                            <div class="mt-3">
                                                                <?php if ($xin_system['logo'] != '' && $xin_system['logo'] != 'no file') { ?>
                                                                    <img src="<?= base_url() . '/public/uploads/logo/' . $xin_system['logo']; ?>"
                                                                         width="70px" style="margin-left:30px;"
                                                                         id="u_file_1">
                                                                <?php } else { ?>
                                                                    <img src="<?= base_url() . '/public/uploads/logo/no_logo.png'; ?>"
                                                                         width="70px" style="margin-left:30px;"
                                                                         id="u_file_1">
                                                                <?php } ?>
                                                            </div>
                                                            ...
                                                            <div class="mt-3">
                                                                <?php if ($xin_system['favicon'] != '' && $xin_system['favicon'] != 'no file') { ?>
                                                                    <img src="<?= base_url() . '/public/uploads/logo/favicon/' . $xin_system['favicon']; ?>"
                                                                         width="16px" style="margin-left:30px;"
                                                                         id="favicon1">
                                                                <?php } else { ?>
                                                                    <img src="<?= base_url() . '/public/uploads/logo/no_logo.png'; ?>"
                                                                         width="16px" style="margin-left:30px;"
                                                        ...
                                                        <div class="custom-file">
                                                            ...
                                                            <div class="mt-3">
                                                                <?php if ($xin_system['other_logo'] != '' && $xin_system['other_logo'] != 'no file') { ?>
                                                                    <img src="<?= base_url() . '/public/uploads/logo/other/' . $xin_system['other_logo']; ?>"
                                                                         width="70px" style="margin-left:30px;"
                                                                         id="u_file3">
                                                                <?php } else { ?>
                                                                    <img src="<?= base_url() . '/public/uploads/logo/no_logo.png'; ?>"
            ...
            <?= lang('Main.xin_acc_payment_gateway'); ?>
                            ...
                            <small class="text-muted d-block m-l-25 m-t-5"><?= lang('Main.xin_change_payment_gateway_settings'); ?></small>
                        </h5>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label">
                                        ...
                                        <span class="text-danger">*</span> </label>
                                    <input class="form-control" placeholder="<?= lang('Main.xin_acc_paypal_email'); ?>"
                                           name="paypal_email" type="text" value="<?= $xin_system['paypal_email']; ?>">
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label">
                                        ...
                                        <span class="text-danger">*</span> </label>
                                    <input class="form-control"
                                           placeholder="<?= lang('Main.xin_acc_stripe_secret_key'); ?>"
                                           name="stripe_secret_key" type="text"
                                           value="<?= $xin_system['stripe_secret_key']; ?>">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">
                                        ...
                                        <span class="text-danger">*</span> </label>
                                    <input class="form-control"
                                           placeholder="<?= lang('Main.xin_acc_stripe_publlished_key'); ?>"
                                           name="stripe_publishable_key" type="text"
                                           value="<?= $xin_system['stripe_publishable_key']; ?>">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">
                                        <?= lang('Main.xin_employees_active'); ?>
            ...
            <div class="tab-pane fade" id="account-notification" role="tabpanel"
            ...
            <?= lang('Main.xin_notification_position'); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="notification_close"
                                   name="notification_close" <?php if ($xin_system['notification_close_btn'] == 'true'): ?> checked="checked" <?php endif; ?>
                                   value="true">
                            <label class="custom-control-label"
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="notification_bar"
                                   name="notification_bar" <?php if ($xin_system['notification_bar'] == 'true'): ?> checked="checked" <?php endif; ?>
                                   value="true">
                            <label class="custom-control-label"
                        ...
                        <div class="bg-white">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="email_type" id="email_type"
                                            ...
                                            <option value="codeigniter" <?php if ($xin_system['email_type'] == 'codeigniter'): ?> selected="selected"<?php endif; ?>>
                                                CodeIgniter v4 Mail()
                                            </option>
                                            <option value="phpmail" <?php if ($xin_system['email_type'] == 'phpmail'): ?> selected="selected"<?php endif; ?>>
                                                PHP Mail()
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="email_notification"
                                       name="email_notification" <?php if ($xin_system['enable_email_notification'] == 1): ?> checked="checked" <?php endif; ?>
                                       value="1">
                                <label class="custom-control-label"
