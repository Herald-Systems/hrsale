                ...
                <table class="table-responsive table">
                    ...
                    <tr>
                        ...
                        <td class="text-right"><span
                                    class="float-right"><?php echo $user_info['first_name'] . '' . $user_info['last_name']; ?></span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="btn-group"><a href="#!" class="text-secondary"><i
                                            class="fas fa-upload m-r-5"></i>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <?php echo $result['resumption_date']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['medical_certificate'] ? 'Yes' : 'No'; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['advance_pay'] ? 'Yes' : 'No'; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['supporting_document'] ? 'Yes' : 'No'; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['require_leave_fare'] ? 'Yes' : 'No'; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['to_be_spent_in']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['leave_address_mail']; ?>
                        </td>
                    </tr>
                    <tr>
                        <th colspan="2">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <?php echo $result['travel_departure_from']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['travel_departure_to']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['travel_departure_mode']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['travel_departure_company']; ?>
                        </td>
                    </tr>
                    <tr>
                        <th colspan="2">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <?php echo $result['travel_returning_from']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['travel_returning_to']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['travel_returning_mode']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['travel_returning_company']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-right">
                            <?php echo $result['is_travelling_time_required'] ? 'Yes' : 'No'; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <i class="fas fa-info m-r-5"></i>
                            Traveling Time Remarks :
                        </td>
                        <td class="text-right">
                            <?php echo $result['travelling_time_remarks']; ?>
                        </td>
                    </tr>
                    </tbody>
                </table>
                    ...
                    <div class="row justify-content-md-center mb-2">
                        <div class="col-md-12">
                            <div class="form-group leave-status">
                                <select class="form-control demo-movie" id="demo-movie" name="status"
                                        autocomplete="off">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control textarea"
                                          placeholder="<?= lang('Recruitment.xin_remarks'); ?>" name="remarks"
                                          id="remarks"><?php echo $result['remarks']; ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body hd-detail hdd-admin border-bottom">
                <div class="row"> <?php echo $result['declaration']; ?> </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="box-block card-dashboard">
                            ...
                            foreach ($leave_types as $type) {
                                ...
                                ?>
                                <p><strong><?php echo $type['category_name']; ?> (<?php echo $count_l; ?>
                                        /<?php echo $days_per_year; ?>)</strong></p>
                                <div class="progress mb-2" style="height:12px;">
                                    <div class="progress-bar <?= $progress_class; ?>"
                                         style="width: <?= $count_data; ?>%;">
                                        <?= round($count_data); ?>
                                        %
                                    </div>
                                </div>
