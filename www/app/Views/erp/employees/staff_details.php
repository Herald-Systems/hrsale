...
<div class="row">
        ...
        <div class="card user-card user-card-1">
            <div class="card-body pb-0">
                ...
                <div class="media user-about-block align-items-center mt-0 mb-3">
                    <div class="position-relative d-inline-block"><img class="img-radius img-fluid wid-80"
                                                                       src="<?= base_url() . '/uploads/users/' . $result['profile_photo']; ?>"
          ...
          <i class="fas fa-question-circle" data-toggle="tooltip" title="Department Head"></i></span> <a href="#"
                                                                                                         class="float-right text-body">
                        <?= $dep_user['first_name'] . ' ' . $dep_user['last_name']; ?>
                    </a></li>
                <li class="list-group-item border-bottom-0"> <span class="f-w-500"><i
                                class="feather icon-mail m-r-10"></i>
          <?= lang('Main.xin_email'); ?>
          ...
          <?= $result['email']; ?>
            ...
            <div class="nav flex-column nav-pills list-group list-group-flush list-pills" id="user-set-tab"
                ...
                <?php if (in_array('staff4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
                    <a class="nav-link list-group-item list-group-item-action active" id="user-set-salary-tab"
                       data-toggle="pill" href="#user-set-salary" role="tab" aria-controls="user-set-salary"
                       aria-selected="false"> <span class="f-w-500"><i class="feather icon-lock m-r-10 h5 "></i>
        <?= lang('Employees.xin_contract'); ?>
        </span> <span class="float-right"><i class="feather icon-chevron-right"></i></span> </a>
                <?php } ?>
                <?php if (in_array('staff4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
                    <a class="nav-link list-group-item list-group-item-action" id="user-set-basicinfo-tab"
                       data-toggle="pill" href="#user-set-basicinfo" role="tab" aria-controls="user-set-basicinfo"
                       aria-selected="false"> <span class="f-w-500"><i class="feather icon-file-text m-r-10 h5 "></i>
        <?= lang('Main.xin_employee_basic_title'); ?>
        </span> <span class="float-right"><i class="feather icon-chevron-right"></i></span> </a>
                <?php } ?>
                <?php if (in_array('staff4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
                    <a class="nav-link list-group-item list-group-item-action" id="user-set-information-tab"
                       data-toggle="pill" href="#user-set-information" role="tab" aria-controls="user-set-information"
        ...
        <?= lang('Main.xin_personal_info'); ?>
                ...
                <?php if (in_array('staff4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
                    <a class="nav-link list-group-item list-group-item-action" id="user-set-picture-tab"
                       data-toggle="pill" href="#user-set-picture" role="tab" aria-controls="user-set-picture"
        ...
        <?= lang('Main.xin_e_details_profile_picture'); ?>
                ...
                <?php if (in_array('staff4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
                    <a class="nav-link list-group-item list-group-item-action" id="user-set-account-tab"
                       data-toggle="pill" href="#user-set-account" role="tab" aria-controls="user-set-account"
                       aria-selected="false"> <span class="f-w-500"><i class="feather icon-book m-r-10 h5 "></i>
        <?= lang('Main.xin_account_info'); ?>
        </span> <span class="float-right"><i class="feather icon-chevron-right"></i></span> </a>
                <?php } ?>
                <?php if (in_array('staff4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
                    <a class="nav-link list-group-item list-group-item-action" id="user-set-document-tab"
                       data-toggle="pill" href="#user-set-document" role="tab" aria-controls="user-set-document"
                       aria-selected="false"> <span class="f-w-500"><i class="feather icon-file-plus m-r-10 h5 "></i>
        <?= lang('Employees.xin_documents'); ?>
        </span> <span class="float-right"><i class="feather icon-chevron-right"></i></span> </a>
                <?php } ?>
                <?php if (in_array('staff4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
                    <a class="nav-link list-group-item list-group-item-action" id="user-set-agenda-tab"
                       data-toggle="pill" href="#user-set-agenda" role="tab" aria-controls="user-set-agenda"
                       aria-selected="false"> <span class="f-w-500"><i class="feather icon-package m-r-10 h5 "></i>
        <?= lang('Employees.xin_timesheet_agenda'); ?>
        </span> <span class="float-right"><i class="feather icon-chevron-right"></i></span> </a>
                <?php } ?>
                <?php if (in_array('staff4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
                    <a class="nav-link list-group-item list-group-item-action" id="user-set-password-tab"
                       data-toggle="pill" href="#user-set-password" role="tab" aria-controls="user-set-password"
                       aria-selected="false"> <span class="f-w-500"><i class="feather icon-shield m-r-10 h5 "></i>
    ...
    <div class="col-lg-8">
        <div class="tab-content" id="user-set-tabContent">
            <?php if (in_array('staff4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
                <div class="tab-pane fade active show" id="user-set-salary" role="tabpanel"
              ...
              <?= lang('Employees.xin_set_contract'); ?>
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item"><a class="nav-link active" id="pills-contract-tab"
                                                        data-toggle="pill" href="#pills-contract" role="tab"
                                ...
                                <li class="nav-item"><a class="nav-link" id="pills-commissions-tab" data-toggle="pill"
                                                        href="#pills-commissions" role="tab"
                                                        aria-controls="pills-commissions" aria-selected="false">
                                        <?= lang('Employees.xin_commissions'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-statutory-tab" data-toggle="pill"
                                                        href="#pills-statutory" role="tab"
                                                        aria-controls="pills-statutory" aria-selected="false">
                                        <?= lang('Employees.xin_satatutory_deductions'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-reimbursements-tab"
                                                        data-toggle="pill" href="#pills-reimbursements" role="tab"
                                                        aria-controls="pills-reimbursements" aria-selected="false">
                                        <?= lang('Employees.xin_reimbursements'); ?>
                                    </a></li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade active show" id="pills-contract" role="tabpanel"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control date"
                                                               name="contract_date"
                                                               placeholder="<?= lang('Employees.xin_contract_date'); ?>"
                                                               value="<?= $employee_detail['date_of_joining']; ?>">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="department">
                                                        <?= lang('Dashboard.left_department'); ?> <span
                                                                class="text-danger">*</span>
                                                    </label>

                                                    <select class="form-control" name="department_id" id="department_id"
                                                            data-plugin="select_hrm"
                                                            data-placeholder="<?= lang('Dashboard.left_department'); ?>">
                                                        <option value="">
                                            ...
                                            <div class="col-sm-4" id="designation_ajax">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="designation_id"
                                                            data-plugin="select_hrm"
                                                            data-placeholder="<?= lang('Dashboard.left_designation'); ?>">
                            ...
                            <?= $xin_system['default_currency']; ?>
                                                        ...
                                                        <input type="text" class="form-control" name="basic_salary"
                                                               placeholder="<?= lang('Employees.xin_gross_salary'); ?>"
                                                               value="<?= $employee_detail['basic_salary']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                            ...
                            <?= $xin_system['default_currency']; ?>
                                                        ...
                                                        <input type="text" class="form-control" name="hourly_rate"
                                                               placeholder="<?= lang('Employees.xin_hourly_rate'); ?>"
                                                               value="<?= $employee_detail['hourly_rate']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="salay_type" id="salay_type" class="form-control"
                                                            data-plugin="select_hrm">
                          ...
                          <?= lang('Membership.xin_per_hour');?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control date" name="contract_end"
                                                               placeholder="<?= lang('Employees.xin_date_of_leaving'); ?>"
                                                               value="<?= $employee_detail['date_of_leaving']; ?>">
                                                        <div class="input-group-append"><span
                                                                    class="input-group-text"><i
                                                                        class="fas fa-calendar-alt"></i></span></div>
                                                    </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="step" data-plugin="select_hrm"
                                                            data-placeholder="<?= lang('Dashboard.designation_step'); ?>">
                                                        <option></option>
                                                        <?php for ($i = 0; $i < 5; $i++) { ?>
                                                            <option
                                                                    value="<?= $i + 1; ?>"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control"
                                                              name="role_description"><?= $employee_detail['role_description']; ?>
</textarea>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="pills-allowances" role="tabpanel"
                                     aria-labelledby="pills-allowances-tab">
                                    <div class="card-body user-profile-list">
                                        <h5 class="mt-1 mb-3 pb-3 border-bottom">
                                            <?= lang('Main.xin_list_all'); ?>
                                            <?= lang('Employees.xin_allowances'); ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="is_allowance_taxable">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                    <select name="contract_tax_option" class="form-control"
                                                            data-plugin="select_hrm">
                                                        <option value="1">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="account_title">
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                    <input class="form-control"
                                                           placeholder="<?= lang('Dashboard.xin_title'); ?>"
                                                           name="option_title" type="text">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                            ...
                            <?= $xin_system['default_currency']; ?>
                                                        ...
                                                        <input class="form-control"
                                                               placeholder="<?= lang('Invoices.xin_amount'); ?>"
                                ...
                                <div class="tab-pane fade" id="pills-commissions" role="tabpanel"
                                     aria-labelledby="pills-commissions-tab">
                                    <div class="card-body user-profile-list">
                                        <h5 class="mt-1 mb-3 pb-3 border-bottom">
                                            <?= lang('Main.xin_list_all'); ?>
                                            <?= lang('Employees.xin_commissions'); ?>
            ...
            <?php if (in_array('staff4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
                <div class="tab-pane fade" id="user-set-basicinfo" role="tabpanel"
                     aria-labelledby="user-set-basicinfo-tab">
                    <div class="card">
                        <div class="card-header">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="date_of_birth">
                                                    <?= lang('Employees.dashboard_employee_id'); ?> <span
                                                            class="text-danger">*</span>
                                                </label>
                                                <input class="form-control"
                                                       placeholder="<?= lang('Employees.dashboard_employee_id'); ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control date"
                                                           placeholder="<?= lang('Employees.xin_employee_dob'); ?>"
                                                           name="date_of_birth" type="text"
                                                           value="<?= $employee_detail['date_of_birth']; ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="marital_status"
                                                        data-plugin="select_hrm"
                                                        data-placeholder="<?= lang('Employees.xin_employee_mstatus'); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="role" data-plugin="select_hrm"
                                                        data-placeholder="<?= lang('Main.xin_employee_role'); ?>">
                                                    <option value=""></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="religion" data-plugin="select_hrm"
                                                        data-placeholder="<?= lang('Employees.xin_ethnicity_type_title'); ?>">
                                                    <option value=""></option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="blood_group" data-plugin="select_hrm"
                                                        data-placeholder="<?= lang('Employees.xin_blood_group'); ?>">
                                                    <option value=""></option>
                                                    <option value="A+" <?php if ($employee_detail['blood_group'] == 'A+'): ?> selected="selected"<?php endif; ?>>
                                                        A+
                                                    </option>
                                                    <option value="A-" <?php if ($employee_detail['blood_group'] == 'A-'): ?> selected="selected"<?php endif; ?>>
                                                        A-
                                                    </option>
                                                    <option value="B+" <?php if ($employee_detail['blood_group'] == 'B+'): ?> selected="selected"<?php endif; ?>>
                                                        B+
                                                    </option>
                                                    <option value="B-" <?php if ($employee_detail['blood_group'] == 'B-'): ?> selected="selected"<?php endif; ?>>
                                                        B-
                                                    </option>
                                                    <option value="AB+" <?php if ($employee_detail['blood_group'] == 'AB+'): ?> selected="selected"<?php endif; ?>>
                                                        AB+
                                                    </option>
                                                    <option value="AB-" <?php if ($employee_detail['blood_group'] == 'AB-'): ?> selected="selected"<?php endif; ?>>
                                                        AB-
                                                    </option>
                                                    <option value="O+" <?php if ($employee_detail['blood_group'] == 'O+'): ?> selected="selected"<?php endif; ?>>
                                                        O+
                                                    </option>
                                                    <option value="O-" <?php if ($employee_detail['blood_group'] == 'O-'): ?> selected="selected"<?php endif; ?>>
                                                        O-
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="country" data-plugin="select_hrm"
                                                        data-placeholder="<?= lang('Employees.xin_nationality'); ?>">
                                                    <option value="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="citizenship_id"
                                                        data-plugin="select_hrm"
                                                        data-placeholder="<?= lang('Employees.xin_citizenship'); ?>">
                                                    <option value="">
                                                        <?= lang('Main.xin_select_one'); ?>
                                                    </option>
                                                    <?php foreach ($all_countries as $country) { ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                       placeholder="<?= lang('Main.xin_address_1'); ?>" name="address_1"
                                        ...
                                        <div class="col-sm-4 form-group pt-4">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input input-primary"
                                                       name="dependant_declaration_logged"
                                                       id="dependant_declaration_logged" value="1"
                                        ...
                                        <div class="col-sm-4 form-group">
                                            ...
                                            <input type="text" class="form-control" name="number_of_children"
                                                   ...
                                                   value="<?= $result['number_of_children']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
              ...
              <?= lang('Main.xin_personal_info'); ?>
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs  mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item"><a class="nav-link active" id="pills-bio-tab" data-toggle="tab"
                                                        href="#pills-bio" role="tab" aria-controls="pills-bio"
                                                        aria-selected="false">
                                        <?= lang('Employees.xin_bio'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-profile-tab" data-toggle="tab"
                                                        href="#pills-profile" role="tab" aria-controls="pills-profile"
                                                        aria-selected="true">
                                        <?= lang('Employees.xin_social_profile'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-bank-tab" data-toggle="tab"
                                                        href="#pills-bank" role="tab" aria-controls="pills-bank"
                                                        aria-selected="false">
                                        <?= lang('Employees.xin_bank_account'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-contact-tab" data-toggle="tab"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>
                                                        <?= lang('Employees.xin_bio'); ?> <span
                                                                class="text-danger">*</span>
                                                    </label>
                                                    <textarea class="form-control" name="bio" rows="4"
                                                              placeholder="<?= lang('Employees.xin_enter_bio'); ?>"><?= $employee_detail['bio']; ?>
</textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span
                                                            class="input-group-text bg-facebook text-white"> <i
                                                                class="fab fa-facebook-f"></i> </span></div>
                                                <input type="text" class="form-control"
                                                       placeholder="<?= lang('Employees.xin_profile_url'); ?>"
                                                       name="fb_profile" value="<?= $employee_detail['fb_profile']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span
                                                            class="input-group-text bg-twitter text-white"> <i
                                                                class="fab fa-twitter"></i> </span></div>
                                                <input type="text" class="form-control"
                                                       placeholder="<?= lang('Employees.xin_profile_url'); ?>"
                                                       name="twitter_profile"
                                                       value="<?= $employee_detail['twitter_profile']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span
                                                            class="input-group-text bg-googleplus text-white"> <i
                                                                class="fab fa-google-plus-g"></i> </span></div>
                                                <input type="text" class="form-control"
                                                       placeholder="<?= lang('Employees.xin_profile_url'); ?>"
                                                       name="gplus_profile"
                                                       value="<?= $employee_detail['gplus_profile']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span
                                                            class="input-group-text bg-linkedin text-white"> <i
                                                                class="fab fa-linkedin-in"></i> </span></div>
                                                <input type="text" class="form-control"
                                                       placeholder="<?= lang('Employees.xin_profile_url'); ?>"
                                                       name="linkedin_profile"
                                                       value="<?= $employee_detail['linkedin_profile']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer text-right">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                           placeholder="<?= lang('Employees.xin_account_title'); ?>"
                                                           name="account_title"
                                                           value="<?= $employee_detail['account_title']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                           placeholder="<?= lang('Employees.xin_account_number'); ?>"
                                                           name="account_number"
                                                           value="<?= $employee_detail['account_number']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                           placeholder="<?= lang('Employees.xin_bank_name'); ?>"
                                                           name="bank_name"
                                                           value="<?= $employee_detail['bank_name']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                           placeholder="<?= lang('Employees.xin_iban'); ?>" name="iban"
                                                           value="<?= $employee_detail['iban']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>
                                                        ...
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                           placeholder="<?= lang('Employees.xin_swift_code'); ?>"
                                                           name="swift_code"
                                                           value="<?= $employee_detail['swift_code']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>
                                                        <?= lang('Employees.xin_bank_branch'); ?> <span
                                                                class="text-danger">*</span>
                                                    </label>
                                                    <textarea class="form-control"
                                                              placeholder="<?= lang('Employees.xin_bank_branch'); ?>"
                                                              name="bank_branch"><?= $employee_detail['bank_branch']; ?>
</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                                        class="fas fa-user"></i></span></div>
                                                        <input type="text" class="form-control"
                                                               placeholder="<?= lang('Employees.xin_full_name'); ?>"
                                                               name="contact_full_name"
                                                               value="<?= $employee_detail['contact_full_name']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                           placeholder="<?= lang('Main.xin_contact_number'); ?>"
                                                           value="<?= $employee_detail['contact_phone_no']; ?>"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               value="<?= $employee_detail['contact_email']; ?>"
                                                               name="contact_email">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>
                                                        <?= lang('Main.xin_address'); ?> <span
                                                                class="text-danger">*</span>
                                                    </label>
                                                    <textarea class="form-control"
                                                              placeholder="<?= lang('Main.xin_address'); ?>"
                                                              name="contact_address"><?= $employee_detail['contact_address']; ?>
</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                            class="fas fa-user"></i></span></div>
                                            <input class="form-control"
                                                   placeholder="<?= lang('Main.dashboard_username'); ?>" name="username"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                            class="fas fa-envelope"></i></span></div>
                                            <input class="form-control"
                                                   placeholder="<?= lang('Employees.xin_account_email'); ?>"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" readonly="readonly" class="form-control" name="pass"
            ...
            <?php if (in_array('staff4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
              ...
              <?= lang('Employees.xin_documents'); ?>
                        ...
                        <div class="card-body">
                            <div class="box-datatable table-responsive">
                                <table class="table table-striped table-bordered dataTable" id="xin_table_document"
                                       style="width:100%;">
                                    <thead>
                                    <tr>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="date_of_expiry" class="control-label">
                                            ...
                                            <span class="text-danger">*</span></label>
                                        <input class="form-control"
                                               placeholder="<?= lang('Employees.xin_document_name'); ?>"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="title" class="control-label">
                                            ...
                                            <span class="text-danger">*</span></label>
                                        <input class="form-control"
                                               placeholder="<?= lang('Employees.xin_document_eg_payslip_etc'); ?>"
            ...
            <?php if (in_array('staff4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
              ...
              <?= lang('Employees.xin_timesheet_agenda'); ?>
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs  mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item"><a class="nav-link active" id="pills-leave_request-tab"
                                                        data-toggle="tab" href="#pills-leave_request" role="tab"
                                                        aria-controls="pills-leave_request" aria-selected="false">
                                        <?= lang('Leave.left_leave_request'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-expense_claim-tab" data-toggle="tab"
                                                        href="#pills-expense_claim" role="tab"
                                                        aria-controls="pills-expense_claim" aria-selected="true">
                                        <?= lang('Dashboard.dashboard_expense_claim'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-loan-tab" data-toggle="tab"
                                                        href="#pills-loan" role="tab" aria-controls="pills-loan"
                                                        aria-selected="false">
                                        <?= lang('Main.xin_request_loan'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-travel-tab" data-toggle="tab"
                                                        href="#pills-travel" role="tab" aria-controls="pills-travel"
                                                        aria-selected="false">
                                        <?= lang('Dashboard.dashboard_travel_request'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-advance_salary-tab" data-toggle="tab"
                                                        href="#pills-advance_salary" role="tab"
                                                        aria-controls="pills-advance_salary" aria-selected="false">
                                        <?= lang('Main.xin_advance_salary'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-overtime-tab" data-toggle="tab"
                                                        href="#pills-overtime" role="tab" aria-controls="pills-overtime"
                                                        aria-selected="false">
                                        <?= lang('Dashboard.xin_overtime_request'); ?>
                                    </a></li>

                                <li class="nav-item"><a class="nav-link" id="pills-awards-tab" data-toggle="tab"
                                                        href="#pills-awards" role="tab" aria-controls="pills-awards"
                                                        aria-selected="false">
                                        <?= lang('Dashboard.left_awards'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-projects-tab" data-toggle="tab"
                                                        href="#pills-projects" role="tab" aria-controls="pills-projects"
                                                        aria-selected="false">
                                        <?= lang('Dashboard.left_projects'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-tasks-tab" data-toggle="tab"
                                                        href="#pills-tasks" role="tab" aria-controls="pills-tasks"
                                                        aria-selected="false">
                                        <?= lang('Dashboard.left_tasks'); ?>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" id="pills-payslip-tab" data-toggle="tab"
                                                        href="#pills-payslip" role="tab" aria-controls="pills-payslip"
                                                        aria-selected="false">
                                        <?= lang('Dashboard.xin_payslip_history'); ?>
                                    </a></li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade active show" id="pills-leave_request" role="tabpanel"
                                     aria-labelledby="pills-leave_request-tab">
                                ...
                                <div class="tab-pane fade" id="pills-expense_claim" role="tabpanel"
                                     aria-labelledby="pills-expense_claim-tab">
                                    <div class="user-profile-list <?php echo $get_animate; ?>">
                                        <div class="card-header">
                                            <h5>
                                                <?= lang('Main.xin_list_all'); ?>
                                ...
                                <div class="tab-pane fade" id="pills-overtime" role="tabpanel"
                                    ...
                                    <div class="<?php echo $get_animate; ?>">
                                        ...
                                        <div class="m-t-20">
                                            <div class="box-datatable table-responsive">
                                                <table class="datatables-demo table table-striped table-bordered"
                                                       id="xin_table_overtime" style="width:100%;">
                                                    <thead>
                                                    <tr>
                                                        <th><?= lang('Dashboard.dashboard_employee'); ?></th>
                                                        <th><?= lang('Main.xin_e_details_date'); ?></th>
                                ...
                                <div class="tab-pane fade" id="pills-awards" role="tabpanel"
                                    ...
                                    <div class="user-profile-list <?php echo $get_animate; ?>">
                                        ...
                                        <div class="m-t-20">
                                            <div class="box-datatable table-responsive">
                                                <table class="datatables-demo table table-striped table-bordered"
                                                       id="xin_table_awards" style="width:100%;">
                                                    <thead>
                                                    <tr>
                                                        <th width="200">
                                ...
                                <div class="tab-pane fade" id="pills-projects" role="tabpanel"
                                    ...
                                    <div class="user-profile-list <?php echo $get_animate; ?>">
                                        ...
                                        <div class="m-t-20">
                                            <div class="box-datatable table-responsive">
                                                <table class="datatables-demo table table-striped table-bordered"
                                                       id="xin_table_projects" style="width:100%;">
                                                    <thead>
                                                    <tr>
                                                        <th><?php echo lang('Dashboard.left_projects'); ?></th>
                                                        <th><?php echo lang('Projects.xin_client'); ?></th>
                                                        <th>
                                                            <i class="fa fa-calendar"></i> <?php echo lang('Projects.xin_start_date'); ?>
                                                        </th>
                                                        <th>
                                                            <i class="fa fa-calendar"></i> <?php echo lang('Projects.xin_end_date'); ?>
                                                        </th>
                                                        <th>
                                                            <i class="fa fa-user"></i> <?php echo lang('Projects.xin_project_users'); ?>
                                                        </th>
                                ...
                                <div class="tab-pane fade" id="pills-tasks" role="tabpanel"
                                    ...
                                    <div class="user-profile-list <?php echo $get_animate; ?>">
                                        ...
                                        <div class="m-t-20">
                                            <div class="box-datatable table-responsive">
                                                <table class="datatables-demo table table-striped table-bordered"
                                                       id="xin_table_tasks" style="width:100%;">
                                                    <thead>
                                                    <tr>
                                ...
                                <div class="tab-pane fade" id="pills-payslip" role="tabpanel"
                                     aria-labelledby="pills-payslip-tab">
                                    <div class="user-profile-list <?php echo $get_animate; ?>">
                                        <div class="card-header">
                                            <h5>
                                                <?= lang('Dashboard.xin_payslip_history'); ?>
                                        ...
                                        <div class="m-t-20">
                                            <div class="box-datatable table-responsive">
                                                <table class="datatables-demo table table-striped table-bordered"
                                                       id="xin_table_payslip" style="width:100%;">
                                                    <thead>
                                                    <tr>
                                                        <th><?= lang('Dashboard.dashboard_employee'); ?></th>
