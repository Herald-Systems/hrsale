...
$Supperannuation = new \App\Models\SuperannuationModel();
$ContractModel = new ContractModel();
$SystemModel = new SystemModel();
$UserdocumentsModel = new UserdocumentsModel();
$get_animate = '';
$xin_system = $SystemModel->where('setting_id', 1)->first();
if ($request->getGet('data') === 'user_loan' && $request->getGet('field_id')) {
    $ifield_id = udecode($field_id);
    $result = $LoansModel->where('id', $ifield_id)->first();
...
//$user_info = $UsersModel->where('user_id', $usession['sup_user_id'])->first();
    ...
    <?= form_open('erp/employees/update_loan', $attributes, $hidden); ?>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control"
                           placeholder="Loan ID" id="loan_id" value="<?= $result['loan_id']; ?>"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control"
                           placeholder="Institution" id="institution" value="<?= $result['institution']; ?>"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control"
                           placeholder="Amount" id="amount" value="<?= $result['amount']; ?>"
                    ...
                    success: function (JSON) {
                        if (JSON.error != '') {
                            ...
                            var xin_table_all_loans = $('#xin_table_all_loans').dataTable({
                                "bDestroy": true,
                                "ajax": {
                                    url: "<?= site_url("erp/employees/loans_list/") . $request->getGet('uid'); ?>",
                                    type: 'GET'
                                },
                                "language": {
...
<?php
} else if ($request->getGet('data') === 'user_superannuation' && $request->getGet('field_id')) {
    $ifield_id = udecode($field_id);
    $result = $Supperannuation->where('id', $ifield_id)->first();
...
//$user_info = $UsersModel->where('user_id', $usession['sup_user_id'])->first();
    ...
    <?php $attributes = array('name' => 'edit_superannuation', 'id' => 'edit_superannuation', 'autocomplete' => 'off', 'class' => 'm-b-1'); ?>
    <?php $hidden = array('_method' => 'EDIT', 'token' => $field_id); ?>
    <?= form_open('erp/employees/update_superannuation', $attributes, $hidden); ?>
    <div class="modal-body">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control"
                           placeholder="Nambawan Super" id="nambawan_super" value="<?= $result['nambawan_super']; ?>"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control"
                           placeholder=" POSF Super" id="posf_super" value="<?= $result['posf_super']; ?>"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            Ladda.bind('button[type=submit]');
            /* Edit data */
            $("#edit_superannuation").submit(function (e) {
                e.preventDefault();
                var obj = $(this), action = obj.attr('name');
                $.ajax({
                    type: "POST",
                    ...
                    success: function (JSON) {
                        if (JSON.error != '') {
                            ...
                            var xin_table_all_superannuation = $('#xin_table_all_superannuation').dataTable({
                                "bDestroy": true,
                                "ajax": {
                                    url: "<?= site_url("erp/employees/superannuation_list/") . $request->getGet('uid'); ?>",
                                    type: 'GET'
                                },
                                "language": {
                                    "lengthMenu": dt_lengthMenu,
...
<?php } else if ($request->getGet('data') === 'user_allowance' && $request->getGet('field_id')) {
    $ifield_id = udecode($field_id);
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="account_title">
                        ...
                        <span class="text-danger">*</span></label>
                    <input class="form-control" placeholder="<?= lang('Dashboard.xin_title'); ?>" name="option_title"
                           type="text" value="<?= $result['option_title']; ?>">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <?= $xin_system['default_currency']; ?>
                        ...
                        <input class="form-control" placeholder="<?= lang('Invoices.xin_amount'); ?>"
                               name="contract_amount" type="text" value="<?= $result['contract_amount']; ?>">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="date_of_expiry" class="control-label">
                        ...
                        <span class="text-danger">*</span></label>
                    <input class="form-control" placeholder="<?= lang('Employees.xin_document_name'); ?>"
                           name="document_name" type="text" value="<?= $result['document_name']; ?>">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="title" class="control-label">
                        ...
                        <span class="text-danger">*</span></label>
                    <input class="form-control" placeholder="<?= lang('Employees.xin_document_eg_payslip_etc'); ?>"
                           name="document_type" type="text" value="<?= $result['document_type']; ?>">
                </div>
            </div>
        </div>
        <div class="row">
