  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class='form-group'>
        ...
        <img src="<?php echo base_url().'/uploads/awards/'.$result['award_photo'];?>" class="d-block" width="70px" id="u_file"> <a href="<?php echo site_url()?>download?type=awards&filename=<?php echo uencode($result['award_photo']);?>">
